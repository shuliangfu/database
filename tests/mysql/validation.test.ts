...
const TABLE_CATEGORIES = "mysql_validation_categories";
const TABLE_BANNED_EMAILS = "mysql_validation_banned_emails";
const TABLE_UNIQUE_TEST = "mysql_validation_unique_test";
...
describe("SQLModel 数据验证", () => {
  ...
  beforeAll(async () => {
    try {
      ...
      console.log("MySQL not available, skipping validation tests");
      console.error(error);
    }
  });
